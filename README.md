...
# Dataset:
The dataset is taken from yahoo finace's website in CSV format. The dataset consists of Open, High, Low, Adj Closing and Closing Prices of Apple Inc. stocks from 3rd january 2000 to 31st December 2023. 
# Price Indicator:
